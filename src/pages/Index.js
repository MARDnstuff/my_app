        ...
        <div className="container-form">
            <form className="form-react" onSubmit={onSubmit}>
                ...
                <div className="form-group mb-3">
                    ...
                    <input onChange={onChange} value={form.email} name="user" type="text" className="form-control" id="user" placeholder="..." />
                </div>

                <div className="form-group mb-4">
                    <label htmlFor="born_date" className="form-label">Fecha de nacimiento</label>
                    <input onChange={onChange} value={form.pass} name="born_date" type="date" className="form-control" id="born_date" placeholder="..." />
                </div>

                <div className="form-group mb-3">
                    <label htmlFor="degree" className="form-label">Licenciatura</label>
                    <input onChange={onChange} value={form.email} name="degree" type="text" className="form-control" id="degree" placeholder="..." />
                </div>
